...
export interface InteractionChannelParticipantContext {
     ...
     */
    updateWithHttpInfo(params: InteractionChannelParticipantContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>>;
    /**
...
export interface InteractionChannelParticipantListInstance {
     ...
     * @returns Resolves to processed InteractionChannelParticipantInstance with HTTP metadata
     */
    createWithHttpInfo(params: InteractionChannelParticipantListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<InteractionChannelParticipantInstance>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance>>;
    /**
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: InteractionChannelParticipantInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: InteractionChannelParticipantListInstanceEachOptions, callback?: (item: InteractionChannelParticipantInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantPage>) => any): Promise<ApiResponse<InteractionChannelParticipantPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantInstance[]>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance[]>>;
    listWithHttpInfo(params: InteractionChannelParticipantListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantInstance[]>) => any): Promise<ApiResponse<InteractionChannelParticipantInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantPage>) => any): Promise<ApiResponse<InteractionChannelParticipantPage>>;
    pageWithHttpInfo(params: InteractionChannelParticipantListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<InteractionChannelParticipantPage>) => any): Promise<ApiResponse<InteractionChannelParticipantPage>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
