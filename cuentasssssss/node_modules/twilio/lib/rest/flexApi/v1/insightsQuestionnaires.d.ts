...
export interface InsightsQuestionnairesContext {
    ...
    /**
     * Remove a InsightsQuestionnairesInstance and return HTTP info
     *
     * @param callback - Callback to handle processed record
     *
     ...
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed InsightsQuestionnairesInstance with HTTP metadata
     */
    removeWithHttpInfo(params: InsightsQuestionnairesContextRemoveOptions, callback?: (error: Error | null, item?: ApiResponse<boolean>) => any): Promise<ApiResponse<boolean>>;
    /**
    ...
    /**
     * Fetch a InsightsQuestionnairesInstance and return HTTP info
     *
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed InsightsQuestionnairesInstance with HTTP metadata
     */
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    /**
     * Fetch a InsightsQuestionnairesInstance and return HTTP info
     *
     * @param params - Parameter for request
     ...
     * @returns Resolves to processed InsightsQuestionnairesInstance with HTTP metadata
     */
    fetchWithHttpInfo(params: InsightsQuestionnairesContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    /**
    ...
    /**
     * Update a InsightsQuestionnairesInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed InsightsQuestionnairesInstance with HTTP metadata
     */
    updateWithHttpInfo(params: InsightsQuestionnairesContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    /**
...
export declare class InsightsQuestionnairesContextImpl implements InsightsQuestionnairesContext {
    ...
    removeWithHttpInfo(params?: InsightsQuestionnairesContextRemoveOptions | ((error: Error | null, item?: ApiResponse<boolean>) => any), callback?: (error: Error | null, item?: ApiResponse<boolean>) => any): Promise<ApiResponse<boolean>>;
    ...
    fetchWithHttpInfo(params?: InsightsQuestionnairesContextFetchOptions | ((error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any), callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    update(params: InsightsQuestionnairesContextUpdateOptions, callback?: (error: Error | null, item?: InsightsQuestionnairesInstance) => any): Promise<InsightsQuestionnairesInstance>;
    updateWithHttpInfo(params: InsightsQuestionnairesContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    /**
     * Provide a user-friendly representation
...
export interface InsightsQuestionnairesListInstance {
    ...
    /**
     * Create a InsightsQuestionnairesInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed InsightsQuestionnairesInstance with HTTP metadata
     */
    createWithHttpInfo(params: InsightsQuestionnairesListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<InsightsQuestionnairesInstance>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance>>;
    /**
    ...
    /**
     * Streams InsightsQuestionnairesInstance records from the API with HTTP metadata captured per page.
     *
     * This operation lazily loads records as efficiently as possible until the limit
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: InsightsQuestionnairesInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: InsightsQuestionnairesListInstanceEachOptions, callback?: (item: InsightsQuestionnairesInstance, done: (err?: Error) => void) => void): void;
    /**
    ...
    /**
     * Retrieve a single target page of InsightsQuestionnairesInstance records from the API with HTTP metadata.
     *
     * The request is executed immediately.
     *
     * @param { string } [targetUrl] - API-generated URL for the requested results page
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<InsightsQuestionnairesPage>) => any): Promise<ApiResponse<InsightsQuestionnairesPage>>;
    /**
    ...
    /**
     * Lists InsightsQuestionnairesInstance records from the API as a list with HTTP metadata.
     *
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<InsightsQuestionnairesInstance[]>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance[]>>;
    listWithHttpInfo(params: InsightsQuestionnairesListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<InsightsQuestionnairesInstance[]>) => any): Promise<ApiResponse<InsightsQuestionnairesInstance[]>>;
    /**
    ...
    /**
     * Retrieve a single page of InsightsQuestionnairesInstance records from the API with HTTP metadata.
     *
     * The request is executed immediately.
     *
     * If a function is passed as the first argument, it will be used as the callback
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<InsightsQuestionnairesPage>) => any): Promise<ApiResponse<InsightsQuestionnairesPage>>;
    pageWithHttpInfo(params: InsightsQuestionnairesListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<InsightsQuestionnairesPage>) => any): Promise<ApiResponse<InsightsQuestionnairesPage>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
