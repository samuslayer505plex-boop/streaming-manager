...
import { UserConversationListInstance } from "twilio/lib/rest/conversations/v1/service/user/userConversation";
...
export interface UserContext {
     ...
     */
    removeWithHttpInfo(params: UserContextRemoveOptions, callback?: (error: Error | null, item?: ApiResponse<boolean>) => any): Promise<ApiResponse<boolean>>;
    /**
...
export declare class UserContextImpl implements UserContext {
    ...
    removeWithHttpInfo(params?: UserContextRemoveOptions | ((error: Error | null, item?: ApiResponse<boolean>) => any), callback?: (error: Error | null, item?: ApiResponse<boolean>) => any): Promise<ApiResponse<boolean>>;
    fetch(callback?: (error: Error | null, item?: UserInstance) => any): Promise<UserInstance>;
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<UserInstance>) => any): Promise<ApiResponse<UserInstance>>;
