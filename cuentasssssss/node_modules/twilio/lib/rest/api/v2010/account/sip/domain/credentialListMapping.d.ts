...
export interface CredentialListMappingContext {
     ...
     */
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<CredentialListMappingInstance>) => any): Promise<ApiResponse<CredentialListMappingInstance>>;
    /**
...
export interface CredentialListMappingListInstance {
     ...
     * @returns Resolves to processed CredentialListMappingInstance with HTTP metadata
     */
    createWithHttpInfo(params: CredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<CredentialListMappingInstance>) => any): Promise<ApiResponse<CredentialListMappingInstance>>;
    /**
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: CredentialListMappingInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: CredentialListMappingListInstanceEachOptions, callback?: (item: CredentialListMappingInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<CredentialListMappingPage>) => any): Promise<ApiResponse<CredentialListMappingPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<CredentialListMappingInstance[]>) => any): Promise<ApiResponse<CredentialListMappingInstance[]>>;
    listWithHttpInfo(params: CredentialListMappingListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<CredentialListMappingInstance[]>) => any): Promise<ApiResponse<CredentialListMappingInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<CredentialListMappingPage>) => any): Promise<ApiResponse<CredentialListMappingPage>>;
    pageWithHttpInfo(params: CredentialListMappingListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<CredentialListMappingPage>) => any): Promise<ApiResponse<CredentialListMappingPage>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
