...
export interface YesterdayListInstance {
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: YesterdayInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: YesterdayListInstanceEachOptions, callback?: (item: YesterdayInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<YesterdayPage>) => any): Promise<ApiResponse<YesterdayPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<YesterdayInstance[]>) => any): Promise<ApiResponse<YesterdayInstance[]>>;
    listWithHttpInfo(params: YesterdayListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<YesterdayInstance[]>) => any): Promise<ApiResponse<YesterdayInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<YesterdayPage>) => any): Promise<ApiResponse<YesterdayPage>>;
    pageWithHttpInfo(params: YesterdayListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<YesterdayPage>) => any): Promise<ApiResponse<YesterdayPage>>;
    /**
