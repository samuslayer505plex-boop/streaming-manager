...
export interface VoipListInstance {
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: VoipInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: VoipListInstanceEachOptions, callback?: (item: VoipInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<VoipPage>) => any): Promise<ApiResponse<VoipPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<VoipInstance[]>) => any): Promise<ApiResponse<VoipInstance[]>>;
    listWithHttpInfo(params: VoipListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<VoipInstance[]>) => any): Promise<ApiResponse<VoipInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<VoipPage>) => any): Promise<ApiResponse<VoipPage>>;
    pageWithHttpInfo(params: VoipListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<VoipPage>) => any): Promise<ApiResponse<VoipPage>>;
    /**
