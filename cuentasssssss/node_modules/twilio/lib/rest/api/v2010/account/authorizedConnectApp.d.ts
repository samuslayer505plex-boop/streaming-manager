...
export interface AuthorizedConnectAppContext {
     ...
     */
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AuthorizedConnectAppInstance>) => any): Promise<ApiResponse<AuthorizedConnectAppInstance>>;
    /**
...
export interface AuthorizedConnectAppListInstance {
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: AuthorizedConnectAppInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: AuthorizedConnectAppListInstanceEachOptions, callback?: (item: AuthorizedConnectAppInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppPage>) => any): Promise<ApiResponse<AuthorizedConnectAppPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppInstance[]>) => any): Promise<ApiResponse<AuthorizedConnectAppInstance[]>>;
    listWithHttpInfo(params: AuthorizedConnectAppListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppInstance[]>) => any): Promise<ApiResponse<AuthorizedConnectAppInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppPage>) => any): Promise<ApiResponse<AuthorizedConnectAppPage>>;
    pageWithHttpInfo(params: AuthorizedConnectAppListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<AuthorizedConnectAppPage>) => any): Promise<ApiResponse<AuthorizedConnectAppPage>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
