...
export interface AuthCallsCredentialListMappingContext {
     ...
     */
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<AuthCallsCredentialListMappingInstance>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance>>;
    /**
...
export interface AuthCallsCredentialListMappingListInstance {
     ...
     * @returns Resolves to processed AuthCallsCredentialListMappingInstance with HTTP metadata
     */
    createWithHttpInfo(params: AuthCallsCredentialListMappingListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<AuthCallsCredentialListMappingInstance>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance>>;
    /**
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: AuthCallsCredentialListMappingInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: AuthCallsCredentialListMappingListInstanceEachOptions, callback?: (item: AuthCallsCredentialListMappingInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingPage>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingInstance[]>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance[]>>;
    listWithHttpInfo(params: AuthCallsCredentialListMappingListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingInstance[]>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingPage>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingPage>>;
    pageWithHttpInfo(params: AuthCallsCredentialListMappingListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<AuthCallsCredentialListMappingPage>) => any): Promise<ApiResponse<AuthCallsCredentialListMappingPage>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
