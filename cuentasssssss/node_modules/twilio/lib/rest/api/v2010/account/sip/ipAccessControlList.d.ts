...
import { IpAddressListInstance } from "twilio/lib/rest/api/v2010/account/sip/ipAccessControlList/ipAddress";
/**
...
export interface IpAccessControlListContext {
     ...
     * @returns Resolves to processed IpAccessControlListInstance with HTTP metadata
     */
    updateWithHttpInfo(params: IpAccessControlListContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<IpAccessControlListInstance>) => any): Promise<ApiResponse<IpAccessControlListInstance>>;
    /**
