...
export interface SiprecContext {
    ...
    /**
     * Update a SiprecInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     ...
     */
    updateWithHttpInfo(params: SiprecContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>>;
    /**
...
export interface SiprecListInstance {
     ...
     * @returns Resolves to processed SiprecInstance with HTTP metadata
     */
    createWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>>;
    /**
     * Create a SiprecInstance and return HTTP info
     *
     * @param params - Parameter for request
     ...
     * @returns Resolves to processed SiprecInstance with HTTP metadata
     */
    createWithHttpInfo(params: SiprecListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<SiprecInstance>) => any): Promise<ApiResponse<SiprecInstance>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
