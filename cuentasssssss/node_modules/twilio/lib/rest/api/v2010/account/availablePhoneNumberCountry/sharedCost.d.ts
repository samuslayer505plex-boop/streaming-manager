...
export interface SharedCostListInstance {
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: SharedCostInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: SharedCostListInstanceEachOptions, callback?: (item: SharedCostInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<SharedCostPage>) => any): Promise<ApiResponse<SharedCostPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<SharedCostInstance[]>) => any): Promise<ApiResponse<SharedCostInstance[]>>;
    listWithHttpInfo(params: SharedCostListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<SharedCostInstance[]>) => any): Promise<ApiResponse<SharedCostInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<SharedCostPage>) => any): Promise<ApiResponse<SharedCostPage>>;
    pageWithHttpInfo(params: SharedCostListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<SharedCostPage>) => any): Promise<ApiResponse<SharedCostPage>>;
    /**
