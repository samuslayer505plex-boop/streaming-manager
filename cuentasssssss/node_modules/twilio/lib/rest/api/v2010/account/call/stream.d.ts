...
export interface StreamContext {
    ...
    /**
     * Update a StreamInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed StreamInstance with HTTP metadata
     */
    updateWithHttpInfo(params: StreamContextUpdateOptions, callback?: (error: Error | null, item?: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>>;
    /**
...
export interface StreamListInstance {
    ...
    /**
     * Create a StreamInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed StreamInstance with HTTP metadata
     */
    createWithHttpInfo(params: StreamListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<StreamInstance>) => any): Promise<ApiResponse<StreamInstance>>;
    /**
     * Provide a user-friendly representation
     */
    toJSON(): any;
