...
export interface NationalListInstance {
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: NationalInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: NationalListInstanceEachOptions, callback?: (item: NationalInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<NationalPage>) => any): Promise<ApiResponse<NationalPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<NationalInstance[]>) => any): Promise<ApiResponse<NationalInstance[]>>;
    listWithHttpInfo(params: NationalListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<NationalInstance[]>) => any): Promise<ApiResponse<NationalInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<NationalPage>) => any): Promise<ApiResponse<NationalPage>>;
    pageWithHttpInfo(params: NationalListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<NationalPage>) => any): Promise<ApiResponse<NationalPage>>;
    /**
