...
export interface LocalListInstance {
    ...
    /**
     * Create a LocalInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed LocalInstance with HTTP metadata
     */
    createWithHttpInfo(params: LocalListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<LocalInstance>) => any): Promise<ApiResponse<LocalInstance>>;
    /**
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: LocalInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: LocalListInstanceEachOptions, callback?: (item: LocalInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<LocalPage>) => any): Promise<ApiResponse<LocalPage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<LocalInstance[]>) => any): Promise<ApiResponse<LocalInstance[]>>;
    listWithHttpInfo(params: LocalListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<LocalInstance[]>) => any): Promise<ApiResponse<LocalInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<LocalPage>) => any): Promise<ApiResponse<LocalPage>>;
    pageWithHttpInfo(params: LocalListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<LocalPage>) => any): Promise<ApiResponse<LocalPage>>;
    /**
