...
export interface TollFreeListInstance {
    ...
    /**
     * Create a TollFreeInstance and return HTTP info
     *
     * @param params - Parameter for request
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed TollFreeInstance with HTTP metadata
     */
    createWithHttpInfo(params: TollFreeListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<TollFreeInstance>) => any): Promise<ApiResponse<TollFreeInstance>>;
    /**
     ...
     * @param { function } [callback] - Function to process each record
     */
    eachWithHttpInfo(callback?: (item: TollFreeInstance, done: (err?: Error) => void) => void): void;
    eachWithHttpInfo(params: TollFreeListInstanceEachOptions, callback?: (item: TollFreeInstance, done: (err?: Error) => void) => void): void;
    /**
     ...
     */
    getPageWithHttpInfo(targetUrl: string, callback?: (error: Error | null, items: ApiResponse<TollFreePage>) => any): Promise<ApiResponse<TollFreePage>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    listWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<TollFreeInstance[]>) => any): Promise<ApiResponse<TollFreeInstance[]>>;
    listWithHttpInfo(params: TollFreeListInstanceOptions, callback?: (error: Error | null, items: ApiResponse<TollFreeInstance[]>) => any): Promise<ApiResponse<TollFreeInstance[]>>;
    /**
     ...
     * @param { function } [callback] - Callback to handle list of records with metadata
     */
    pageWithHttpInfo(callback?: (error: Error | null, items: ApiResponse<TollFreePage>) => any): Promise<ApiResponse<TollFreePage>>;
    pageWithHttpInfo(params: TollFreeListInstancePageOptions, callback?: (error: Error | null, items: ApiResponse<TollFreePage>) => any): Promise<ApiResponse<TollFreePage>>;
    /**
