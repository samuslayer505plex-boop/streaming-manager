...
export interface RecordingListInstance {
     ...
     * @returns Resolves to processed RecordingInstance with HTTP metadata
     */
    createWithHttpInfo(params: RecordingListInstanceCreateOptions, callback?: (error: Error | null, item?: ApiResponse<RecordingInstance>) => any): Promise<ApiResponse<RecordingInstance>>;
    /**
