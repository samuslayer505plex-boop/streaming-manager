...
export interface WorkspaceCumulativeStatisticsContext {
    ...
    /**
     * Fetch a WorkspaceCumulativeStatisticsInstance and return HTTP info
     *
     * @param callback - Callback to handle processed record
     *
     * @returns Resolves to processed WorkspaceCumulativeStatisticsInstance with HTTP metadata
     */
    fetchWithHttpInfo(callback?: (error: Error | null, item?: ApiResponse<WorkspaceCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceCumulativeStatisticsInstance>>;
    /**
     * Fetch a WorkspaceCumulativeStatisticsInstance and return HTTP info
     *
     * @param params - Parameter for request
     ...
     * @returns Resolves to processed WorkspaceCumulativeStatisticsInstance with HTTP metadata
     */
    fetchWithHttpInfo(params: WorkspaceCumulativeStatisticsContextFetchOptions, callback?: (error: Error | null, item?: ApiResponse<WorkspaceCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceCumulativeStatisticsInstance>>;
    /**
...
export declare class WorkspaceCumulativeStatisticsContextImpl implements WorkspaceCumulativeStatisticsContext {
    ...
    fetchWithHttpInfo(params?: WorkspaceCumulativeStatisticsContextFetchOptions | ((error: Error | null, item?: ApiResponse<WorkspaceCumulativeStatisticsInstance>) => any), callback?: (error: Error | null, item?: ApiResponse<WorkspaceCumulativeStatisticsInstance>) => any): Promise<ApiResponse<WorkspaceCumulativeStatisticsInstance>>;
    /**
     * Provide a user-friendly representation
     *
     * @returns Object
